      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <div class="card" style={{ width: "25rem" }}>
            ...
            <div class="card-body">
              <p class="card-text"> Vertex AI - Data acquisition and Exploration</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div class="card" style={{ width: "25rem" }}>
            ...
            <div class="card-body">
              <p class="card-text">Python with IIT Certification</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div class="card" style={{ width: "25rem" }}>
            ...
            <div class="card-body">
              <p class="card-text">RPA Design & Development V2.0</p>
            </div>
          </div>
        </div>
